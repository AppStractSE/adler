  ...
  return (
    <section className={className}>
      <div className="max-page-width flex flex-col items-center gap-4 px-4 py-12 md:gap-8 md:py-24">
        <h2 className="text-balance text-center text-3xl font-medium tracking-wide sm:text-4xl md:text-4xl">
          Placeholder
        </h2>
        ...
        {visibleCount < content.projects.length && (
          <div className="mt-12 flex justify-center">
            <button
              onClick={LoadMore}
              className="flex w-fit items-center justify-center rounded-sm bg-neutral-900 px-6 py-2.5 text-base text-background transition-all duration-300 ease-in-out hover:bg-neutral-800"
            >
              Visa fler
            </button>
          </div>
