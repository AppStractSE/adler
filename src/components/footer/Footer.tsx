        ...
        <div className="flex flex-wrap gap-12 md:gap-24">
            ...
            <div className="flex flex-col gap-4">
              {footerlinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="flex w-fit items-center gap-2 text-lg font-light hover:text-neutral-500 md:text-3xl"
                >
                  {link.name}
                </Link>
              ))}
          ...
          <div className="flex min-w-fit flex-col gap-8">
            ...
            <div className="flex flex-col gap-2">
              <Link
                className="whitespace-pre-line text-lg font-light hover:text-neutral-500 md:text-lg"
              ...
              <Link
                className="text-lg font-light hover:text-neutral-500 md:text-lg"
            ...
            <div className="flex flex-col gap-2">
              {socials.map((social) => (
                <Link
                  ...
                  href={social.href}
                  target="_blank"
                  className="flex w-fit items-center gap-2 text-lg font-light hover:text-neutral-500 md:text-lg"
                >
